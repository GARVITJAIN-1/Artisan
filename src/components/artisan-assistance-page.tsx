    ...
    <>
      <Tabs defaultValue={defaultTab} className="flex flex-col flex-grow">
        <TabsList className="grid w-full grid-cols-3 bg-transparent py-2">
          <TabsTrigger
            value="sourcing"
            className="pb-2 rounded-none border-b-2 border-transparent text-muted-foreground data-[state=active]:border-primary data-[state=active]:text-primary"
          >
            Sourcing & Pricing
          </TabsTrigger>
          <TabsTrigger
        ...
        <TabsContent
          value="ideas"
          className="flex-grow flex flex-col justify-center gap-6 mt-0"
        >
          <Card>
            <CardHeader>
